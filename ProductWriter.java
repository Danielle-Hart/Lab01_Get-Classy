...
public class ProductWriter {
    public static void main(String[] args) {
        ...
        do {
            ID = SafeInput.getNonZeroLenString("Product ID");
            Name = SafeInput.getNonZeroLenString("Product Name");
            Description = SafeInput.getNonZeroLenString("Product Description");
            ...
            doneInput = !SafeInput.getYNConfirm("Do you have more products to enter?");
        } while (!doneInput);

        //File Name
        String fileName = SafeInput.getNonZeroLenString("Enter the name you would like to save your record as");
